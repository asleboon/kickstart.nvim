return {
  ...
  config = function()
    ...
    -- Show unused variables in gray italic text
    ...
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        map('<leader>lm', vim.lsp.buf.rename, 'Rename Symbol')

        -- Jump to the definition of the word under your cursor.
        --  This is where a variable was first declared, or where a function is defined, etc.
        --  To jump back, press <C-t>.
        map('<leader>ld', tb.lsp_definitions, 'Goto [d]efinition')

        -- Jump to the implementation of the word under your cursor.
        --  Useful when your language has ways of declaring types without an actual implementation.
        map('<leader>li', tb.lsp_implementations, 'Goto [i]mplementation')

        -- Find references for the word under your cursor.
        map('<leader>lr', tb.lsp_references, 'Goto References')

        -- Jump to the type of the word under your cursor.
        --  Useful when you're not sure what type a variable is and you want to see
        --  the definition of its *type*, not where it was *defined*.
        map('<leader>lt', tb.lsp_type_definitions, 'Goto Type Definition')
        ...
        --  Useful for quickly inspecting errors and warnings inline.
        map('<leader>le', vim.diagnostic.open_float, 'Line Diagnostics')

        -- Populate the location list with all diagnostics in the current buffer.
        --  Useful for getting an overview and jumping between issues.
        map('<leader>lq', vim.diagnostic.setloclist, 'Diagnostics List')

        -- Show hover information for the symbol under the cursor.
        --  This typically includes type information and inline documentation,
        --  such as inferred types, function signatures, and doc comments.
